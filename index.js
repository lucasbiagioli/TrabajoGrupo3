let listMovies = [{
    ...
    },
    {
        ...
        Poster: "https://images.squarespace-cdn.com/content/v1/5f18ac5a45cf2f59d8612fae/1600456400689-TAYJ9WLMTG35JGIBBYIM/Power.jpg",
        Metascore: "N/A",
        imdbRating: "8.0",
        imdbVotes: "14,770",
        imdbID: "tt3281796",
...
// const jsonMovieList = JSON.stringify(listMovies);
let searchInputDOM = document.getElementById('searchBar')
let articleContainerDOM = document.getElementById('movieArticle')
const jsonMovieList = localStorage.getItem('listMovies')
if (jsonMovieList) {
    listMovies = JSON.parse(jsonMovieList)
} else {
...
function generateMovieArticleHTML(listMovies) {
    articleContainerDOM.innerHTML = ''
    let htmlArticles = []
    for (let i = 0; i < listMovies.length; i++) {
        const movie = listMovies[i];
        try {
            const htmlArticle = `
          <div class="movieCard" id="movie-${Date.now()}"> 
          <article class="movie-thumbnail d-flex">
            <img src="${movie.Poster}" alt="${movie.Title}" class="poster">
            <div class="detail">
              <h6 class="title title-font">${movie.Title}</h6>
              <div>
                <span>${movie.Year}</span>&emsp;.&emsp;
                <span>${movie.Genre}</span>
              </div>
              <a href="${movie.id}" class="btn btn-primary mt-4 px-2 w-100">Ver Ahora</a>
            </div>
          </article>
        </div>`
    ...
    articleContainerDOM.innerHTML = htmlArticles.join('')
}
